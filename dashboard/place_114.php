...
<label for="gender"><b>Room Type</b></label><br><br>
...
<input type="radio" placeholder="VIP" name="gender" required>
<label for="other"><b>VIP</b></label><br><br>

<label for="lname"><b>No. Of Guests</b></label>
<input type="text" placeholder="Enter Guests" name="lname" required>
